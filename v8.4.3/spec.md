# V8.4.3 Controlled Orchestration Specification

This is the controlling cold-run specification for V8.4.3. Before taking any
...
- substitute `v8.4.3` for `v8.4` in prompt, run, and artifact paths;
...
V8.4.3 otherwise inherits the V8.4 cold workflow, agent isolation, input
...
```text
v8.4.3/prompts/01_branch_seeded_formation-v8.4.3.md
v8.4.3/prompts/02_recursive_reopening-v8.4.3.md
v8.4.3/prompts/03_reciprocal_scaffold_integration-v8.4.3.md
v8.4.3/prompts/04_compositional_semantic_synthesis-v8.4.3.md
v8.4.3/prompts/05_postdraft_recovery_field-v8.4.3.md
v8.4.3/prompts/06_selective_final_recomposition-v8.4.3.md
```

Write every generated artifact with `v8.4.3` in its filename. The synthesis
paths are:

```text
a2/04-compositional-semantic-synthesis-v8.4.3.md
a2/05-postdraft-recovery-field-v8.4.3.md
a2/06-selective-final-recomposition-v8.4.3.md
```
...
specified in `v8.4/spec.md`, using `v8.4.3/run/` as the version root. A full
...
An exact V8.4.3 run is complete only when one persistent formation author wrote
...
V8.4.2, V8.3, V3, or the S1 audio reference.
