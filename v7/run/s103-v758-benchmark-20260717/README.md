# S103 V7.5.8 Semantic Benchmark

This run binds the prepared S103 input bundle to V7.5.8 Turns 1-5.

```text
semantic component: V7.5.8
passage id:         103
...
```text
v7.5.8/a2/05-postdraft-recomposition-v7.5.8.md
```
