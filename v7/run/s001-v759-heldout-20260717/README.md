# S1 V7.5.9 Semantic Benchmark

This run binds the prepared S1 input bundle to V7.5.9 Turns 1-5.

```text
semantic component: V7.5.9
passage id:         1
input root:         v3/run/s001-full-20260716/inputs/
```
...
```text
v7.5.9/a2/05-postdraft-recomposition-v7.5.9.md
```
