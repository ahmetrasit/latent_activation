# S103 V7.5.3 Semantic Benchmark

This run binds the prepared S103 input bundle to V7.5.3 Tasks 1-5.

```text
semantic component: V7.5.3
passage id:         103
...
```text
v7.5.3/a2/05-semantic-master-tr-v7.5.3.md
```
