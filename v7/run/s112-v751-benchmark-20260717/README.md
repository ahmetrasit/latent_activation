# S112 V7.5.1 Semantic Benchmark

This run binds the prepared S112 input bundle to V7.5.1 Tasks 1-5.

```text
semantic component: V7.5.1
passage id:         112
...
```text
v7.5.1/a2/05-semantic-master-tr-v7.5.1.md
```
