# S103 V7.5.4 Semantic Benchmark

This run binds the prepared S103 input bundle to V7.5.4 Tasks 1-5.

```text
semantic component: V7.5.4
passage id:         103
...
```text
v7.5.4/a2/05-semantic-master-tr-v7.5.4.md
```
