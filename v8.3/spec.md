# V8.3 Cold Orchestration Specification

This file is the executable orchestration contract for running V8.3 on one
...
The four files under `v8.3/prompts/` are authoritative for semantic behavior.
...
For orchestration, this file governs if `v8.3/README.md`, an older run task, or
...
Do not copy or transform the bundle. V8.3 reads the existing input materials in
place.

## 5. Create a non-destructive run root

Unless the user supplies a run label, use `pilot`. Build the run root as
`v8.3/run/sNNN-<label>-YYYYMMDD/` using the local calendar date. The default is:

```text
v8.3/run/sNNN-pilot-YYYYMMDD/
```
...
```text
a1/01-branch-seeded-formations-v8.3.md
a1/02-recursively-expanded-field-v8.3.md
a1/03-reciprocal-formation-field-v8.3.md
a2/04-compositional-semantic-synthesis-v8.3.md
```
...
|---|---|---|---|---|---|
| 1 | persistent Agent 1 | `01_branch_seeded_formation-v8.3.md` | yes | no | none |
| 2 | same Agent 1 | `02_recursive_reopening-v8.3.md` | yes | no | Turn 1 |
| 3 | same Agent 1 | `03_reciprocal_scaffold_integration-v8.3.md` | yes | yes, first exposure | Turns 1–2 |
| 4 | fresh Agent 2 | `04_compositional_semantic_synthesis-v8.3.md` | yes | yes | Turns 1–3 |
...
- `v8.3/README.md` or this orchestration specification;
- any other V8.3 run;
...
```text
You are the persistent V8.3 formation author for Surah <N>. This is Turn 1 of
three turns in the same session.

Read `v8.3/prompts/01_branch_seeded_formation-v8.3.md` completely and follow it.
...
Do not read documentation, prior V3/V7/V8.3 analyses, publications, reference
outputs, or any other passage material. Work only inside the authorized closed
field.

Write the artifact with apply_patch to:
<RUN_ROOT>/a1/01-branch-seeded-formations-v8.3.md
...
Read `v8.3/prompts/02_recursive_reopening-v8.3.md` completely and follow it.
...
Write the artifact with apply_patch to:
<RUN_ROOT>/a1/02-recursively-expanded-field-v8.3.md
...
Read `v8.3/prompts/03_reciprocal_scaffold_integration-v8.3.md` completely and follow
it.
...
Write the artifact with apply_patch to:
<RUN_ROOT>/a1/03-reciprocal-formation-field-v8.3.md
...
```text
You are a fresh independent V8.3 synthesis author for Surah <N>. You did not
write the formation artifacts and have no cross-passage context.

Read `v8.3/prompts/04_compositional_semantic_synthesis-v8.3.md` completely and follow it.
...
Write the artifact with apply_patch to:
<RUN_ROOT>/a2/04-compositional-semantic-synthesis-v8.3.md
...
author into the old reservoir and call it an exact V8.3 run. Start a new Agent 1
...
Previous V3, V7, S1, or other V8.3 outputs may be used only now as comparison
material.
